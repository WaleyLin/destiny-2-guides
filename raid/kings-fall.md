...
| # | Encounter | Type |
|---|-----------|------|
| 1 | [Court of Oryx](#1-court-of-oryx) | Relic relay |
| 2 | [Tomb Ships](#2-tomb-ships) | Jumping puzzle |
| 3 | [Annihilator Totems (Basilica)](#3-annihilator-totems-basilica) | Buff rotation |
| 4 | [Warpriest](#4-warpriest) | Boss fight |
| 5 | [Golgoroth's Maze](#5-golgороths-maze) | Navigation |
| 6 | [Golgoroth](#6-golgoroth) | Boss fight |
| 7 | [The Dick Wall](#7-the-dick-wall) | Jumping puzzle |
| 8 | [Daughters of Oryx](#8-daughters-of-oryx) | Platform puzzle + Boss |
| 9 | [Oryx, The Taken King](#9-oryx-the-taken-king) | Final boss |
...
3. Follow this jump sequence:
   - Ride forward → jump to the **diagonal ship on your right**
   - **Right → Forward** → land on the checkpoint platform
4. From the checkpoint, board the ship to your right and continue:
   - **Forward → hang left (skip one ship) → Forward → Forward → Forward → Forward**
   - The final ship spawns at the last second — don't panic, it appears
...
**Opening phase:**
1. All three Plate Holders step on their plates simultaneously to start
...
**End of phase:**
1. Warpriest fires the **Oculus** blast — **all six players hide behind the same Monolith**
2. That Monolith is destroyed — repeat from enemy clearing
